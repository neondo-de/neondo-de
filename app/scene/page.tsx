  ...
  return (
    <main className="scene-page">
      <nav className="scene-nav">
        <a href="/" className="stage-logo scene-logo"><span className="stage-logo-mark">N</span><span/></a>
      ...
      <footer className="scene-footer"><a href="/" className="stage-logo scene-logo"><span className="stage-logo-mark">N</span><span/></a><span>Discover what’s happening. Find where you fit.</span><a href="/events">Explore the scene ↗</a></footer>
