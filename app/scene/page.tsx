  ...
  return (
    <main className="scene-page">
      <nav className="scene-nav">
        <a href="/" className="scene-logo">NEON<span>DO</span><i /></a>
      ...
      <footer className="scene-footer"><a href="/" className="scene-logo">NEON<span>DO</span><i /></a><span>Discover what’s happening. Find where you fit.</span><a href="/events">Explore the scene ↗</a></footer>
